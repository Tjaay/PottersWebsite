...
$users_token = false;
if( (isset($usegrouptoken) && $usegrouptoken != false) || $useowntoken ){
...
$access_token_array = array(
    ...
    '611606915581035|RdRHbHtrHseQw4C7SDUBFWIrJLA'
);

($users_token) ? $access_token = $users_token : $access_token = $access_token_array[rand(0, 7)];

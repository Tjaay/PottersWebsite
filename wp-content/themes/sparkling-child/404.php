			...
			<div class="post-inner-content">
				...
				<section class="error-404 not-found">
					<header class="page-header">
						<h1 class="page-title"><?php esc_html_e( 'Oops! Appears a pot has broken', 'sparkling' ); ?></h1>
					</header><!-- .page-header -->
					
					<div class="page-content">
						<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try one of the links below?', 'sparkling' ); ?></p>
						<img class="img404">
						<div class="row">

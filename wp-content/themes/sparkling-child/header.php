														...
														<div id="logo">
															<?php if ( get_header_image() != '' ) { ?>
																<?php if ( is_front_page()) { ?>
																	<a href="<?php echo esc_url( home_url( '/contact' ) ); ?>"><img src="<?php header_image(); ?>"  height="<?php echo get_custom_header()->height; ?>" width="<?php echo get_custom_header()->width; ?>" alt="<?php bloginfo( 'name' ); ?>"/></a>
																	<?php } else { ?>
